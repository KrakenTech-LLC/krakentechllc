...
| KERBEROS | <Icon icon="check" /> | <Icon icon="check" /> |  |
...
Users can be deleted in three different ways:

<AccordionGroup>
  <Accordion title="Clicking the x on their card">
    <Frame>
      ![Image](/images/image-93.png)
    </Frame>
  </Accordion>

  <Accordion title="Using the delete all button in the search">
    <Frame>
      ![Image](/images/image-91.png)
    </Frame>
  </Accordion>

  <Accordion title="Using the Delete with filter button in the search bar">
    <Frame>

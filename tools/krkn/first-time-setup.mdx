...
To start, use the krkns install command to create global aliases and initialize the directories for the configurations

![Image](/images/image.png)

Optionally, if you would like to install Krkns as a service, you can now run the service install command
